...
namespace WebApplication_C.Classes
{
    public class Banco
    {
        ...
        //Conta os Municipios
        public static int Listaradmin(string nome, string email, string CPF)
        {
        ...
        public static int Listarpostagem(string nome, string email, string CPF)
        {
        ...
        public static void Deletaradmin(string nome, string sobrenome, string CPF)
        {
            string query = "DELETE FROM Admin WHERE nome='" + nome + "' AND sobrenome='" + sobrenome + "'" +CPF+ "'";
        ...
        public static void Deletarusuario(string nome, string sobrenome, string CPF)
        {
            string query = "DELETE FROM Admin WHERE nome='" + nome + "' AND sobrenome='" + sobrenome + "'";
